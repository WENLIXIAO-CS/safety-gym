...
class Engine(gym.Env, gym.utils.EzPickle):
    ...
    def __init__(self, config={}):
        ...
        self.action_space = gym.spaces.Box(-1, 1, (self.robot.nu,), dtype=np.float64)
    ...
    @property
    def robot_vel(self):
        '''Helper to get current robot velocity'''
    ...
    @property
    def robot_acc(self):
        return self.world.get_sensor('accelerometer').copy()

    @property
    def robot_gyro(self):
        return self.world.get_sensor('gyro').copy()

    @property
    def robot_mvel(self):
        """ velocity measured by velocimeter"""
        return self.world.get_sensor('velocimeter').copy()
    ...
    def selected_obs(self):
        ...
        # if self._aug_state:
        #     return self.augment_obs(sel_obs)
        # else:
        #     return sel_obs
        return sel_obs
    ...
    def obs_vision(self):
        ...
        return np.array(vision, dtype='/loat32') / 255
